                ...
                <Card title="Usuários" style={{ flex: 1, width1: 300 }}>
                    <div>
                        ...
                        <Input
                            ...
                            placeholder="name"
                        ></Input>
                        <Button onClick={this.gravarClick}>gravar</Button>
                    </div>
                    <div>
                        <Button onClick={this.atualizarClick}>atualizar</Button>
                        <Table
                            columns={[
                                {
                                    dataIndex: 'username',
                                ...
                                },
                                {
                                    render: record => {
                                        ...
                                        return <Button onClick={this.editarClick(record)}>editar</Button>;
                                    },
                                },
                            ]}
